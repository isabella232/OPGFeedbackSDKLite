    ...
    @IBAction func updateProfile(_ sender: AnyObject)
    {
        ...
        if(!(profile?.firstName.isEmpty)!)
        {
            do {
                ...
                let alertController = UIAlertController(title: "OPGSDKv0.1.3", message: "Profile Updated Successfully", preferredStyle: .alert)
                ...
                let alertController = UIAlertController(title: "OPGSDKv0.1.3", message: "Profile Update Failed", preferredStyle: .alert)
