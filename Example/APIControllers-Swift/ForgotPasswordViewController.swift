...
class ForgotPasswordViewController: UIViewController, UITextFieldDelegate
{
    ...
    @IBAction func forgotPass(_ sender: AnyObject)
    {
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv0.1.1", message: "Mail Sent Successfully", preferredStyle: .alert)
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv0.1.1", message: "Mail Sending Failed", preferredStyle: .alert)
