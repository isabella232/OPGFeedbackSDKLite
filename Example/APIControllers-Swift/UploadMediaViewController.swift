...
class UploadMediaViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    ...
    func showAlert()
    {
        if(self.mediaID==nil)
        {
            let alertController = UIAlertController(title: "OPGSDKv0.1.1", message: "Media upload failed", preferredStyle: .alert)
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv0.1.1", message: "Uploaded media ID is \(self.mediaID!)", preferredStyle: .alert)
